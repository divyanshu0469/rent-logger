      ...
      >
        {sorted && sorted.length > 0 ? (
          sorted.map((rent, index) => {
            ...
            if (!tenant) {
              return <div key={index}>Tenant Details missing</div>;
            }
            if (tenant.isArchived)
              return (
                ...
                >
                  <AccordionItem
                    value={`rent-${index}`}
                    className="w-full flex flex-col p-2 rounded-md bg-gray-50 text-gray-400"
                  >
                  ...
                  <Button size={"defaultWithNoPadding"} className="bg-gray-500">
                    <Link
